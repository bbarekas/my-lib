...
int main(int argc, char** argv)
{
    ...
    */
    ...
    std::puts("\n ===== [EXPERIMENT 4] Passing Functors to capturing lambda ==\n");
    {
        ...
        mylib_callback_withdata(5, &FunctionObject_adapter, &obj1);
        ...
        FunctionObject obj2;
        mylib_callback_withdata(5, adapter_for_FunctionObject, &obj2);
    }
    ...
    std::puts("\n ===== [EXPERIMENT 5] Passing Capturing lambdas <APPROACH 1> ==\n");
    {
        ...
        mylib_callback_withdata(5, adpter_for_lambda, &callback_object);
